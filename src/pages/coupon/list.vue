    ...
    <el-card shadow="never" class="border-0">
      ...
      <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
        <el-form ref="formRef" :model="form" :rules="rules" status-icon label-width="80px" :inline="false">
          ...
          <el-form-item label="类型" prop="desc">
            <el-radio-group v-model="form.desc">
              <el-radio :label="1" border-0>满减</el-radio>
              <el-radio :label="0" border-0>折扣</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-form>
        <el-form-item label="面值" prop="value">
          <el-input v-model="form.value" placeholder="公告内容" type="textarea" />
        </el-form-item>
        <el-form-item label="发行量" prop="total">
          <el-input-number v-model="form.total" :min="0" :max="1000" />
        </el-form-item>
        <el-form-item label="最低使用价格" prop="content">
          <el-input v-model="form.content" placeholder="公告内容" type="textarea" />
        </el-form-item>
        ...
        <el-form-item label="描述" prop="content">
          <el-input v-model="form.content" placeholder="描述" type="textarea" :rows="5" />
        </el-form-item>
      </FormDrawer>
    </el-card>
